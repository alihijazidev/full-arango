      ...
      <Tabs defaultValue="data" className="flex-1 flex flex-col overflow-hidden">
        <div className="px-4 pt-4 shrink-0">
          <TabsList className="w-full bg-slate-100/80 p-1">
            <TabsTrigger value="data" className="flex-1 gap-2 text-xs">
              <Database size={14} />
              البيانات
            </TabsTrigger>
            <TabsTrigger value="analysis" className="flex-1 gap-2 text-xs">
              <Activity size={14} />
              التحليل
            </TabsTrigger>
          </TabsList>
        ...
        <TabsContent value="analysis" className="flex-1 flex flex-col overflow-hidden m-0">
          <AnalysisTab />
        </TabsContent>
      </Tabs>
    </div>
